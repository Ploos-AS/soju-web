...
func (a *app) channelsPage(w http.ResponseWriter, r *http.Request) {
	...
	data := channelsPageData{
		...
		User:    username,
		Network: network,
		Notice:  channelNoticeText(r.URL.Query().Get("ok")),
	}
	if username != "" && network != "" {
