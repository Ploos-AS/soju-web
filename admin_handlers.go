...
func (a *app) usersPage(w http.ResponseWriter, r *http.Request) {
	...
	data := usersPageData{
		...
		Lines:      lines,
		Users:      makeUserRows(parseUserStatuses(lines)),
