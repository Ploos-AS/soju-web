...
func (a *app) networksPage(w http.ResponseWriter, r *http.Request) {
	...
	if username != "" {
		...
		data.Lines = lines
		data.Networks = makeNetworkRows(username, parseNetworkStatuses(lines))
		if err != nil {
